...
if __name__ == '__main__':
    ...
    window_size=[32, 40, 48, 56, 64, 80]#[64, 80, 96, 112, 128, 160]#, 192, 224, 256]
    window_roi=[((100, 200),(540, 275)), ((50, 200),(590, 275)), ((0, 190),(640, 275)),
                ((0, 180),(640, 275)), ((0, 180),(640, 300)), ((0, 180),(640, 335)) ]#resize for 640*360
    ...
    '''
    cap = cv2.VideoCapture('Test_640*360.mp4')
    ...
    while(cap.isOpened()):
        ...
        print(str(round((1000/(1000*exec_time)),1))+ str(pixels_per_meter))
